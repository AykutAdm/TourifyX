...
namespace BusinessLayer.Container
{
    public static class Extensions
    {
        ...
        {
            //Newleme Bağımlılıklarından kurtulduk manager sınıfını. Service sınıfından constructor üretiyoruz artık bunu tanımladık aşağıda.
            ...
            services.AddScoped<ISentMailService, SentMailManager>();
            services.AddScoped<ISentMailDal, EfSentMailDal>();
